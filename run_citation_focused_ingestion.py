...
# Simple imports - focusing on the essentials
from src.ingestion_core import SimplePipeline, ingest_documents
...
def main():
    ...
    print("\nTo verify quality, run: python verify_simple_quality.py")
